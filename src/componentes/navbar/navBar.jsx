          ...
          <div className="collapse navbar-collapse" id="navbarNav">
            <ul className="navbar-nav ">
              <li className="nav-item ">
                <Link to="/categoria/shampoo" className="nav-link">
                  Shampoos
                </Link>
              </li>
              <li className="nav-item">
                <Link to="/categoria/acondicionador" className="nav-link">
                  Acondicionadores
                </Link>
              </li>
              <li className="nav-item">
                <Link to="/categoria/cremas" className="nav-link">
                  Cremas Hidratantes
                </Link>
              </li>
              <li className="nav-item">
                <Link to="/categoria/accesorios" className="nav-link">
                  Accesorios
                </Link>
              </li>
            </ul>
